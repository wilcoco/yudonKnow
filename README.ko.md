...
> **대부분의 AI 는 당신의 질문에 답한다. 이건 당신에게 묻는다.**
> **선배는 떠나도, 판단은 남는다.**

퇴직과 함께 사라지는 것은 문서가 아니라 **상황을 읽는 눈**이다.
사출 불량이 온도가 아니라 속도 문제인 걸 어떻게 아느냐고 물으면
*"그냥 보면 압니다"* 라고 한다. 숨기는 게 아니다 —
**누가 제대로 물어보기 전까지는 자기가 뭘 아는지 본인도 모른다.**

그래서 백지 인수인계서도, 위키도, 사내 문서 RAG 챗봇도 같은 자리에서 깨진다.
암묵지를 꺼내는 일은 원래 **사람 지식공학자가 마주 앉아 인터뷰**해야 했다.
그런 사람은 부족하고, 비싸고, 퇴직하는 모든 전문가에게 배정할 수 없다.

**그 자리에 에이전트를 앉혔다.** 사람이 원천이고 에이전트가 면접자다.
이 뒤집힘이 나머지 전부를 결정한다 — 카드에 무엇이 담기는지, 분신이 무엇까지
말해도 되는지, 언제 답하지 말아야 하는지.
